        ...
        >
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Button
              variant="secondary"
              size="lg"
              className="w-full rounded-full px-8 py-6 text-base shadow-[0_18px_45px_rgba(15,23,42,0.15)] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_25px_55px_rgba(15,23,42,0.25)] sm:w-auto"
              onClick={() => navigate('/notes')}
            >
              View your notes
            </Button>
          </div>
          <div className="flex items-center gap-6 text-xs uppercase tracking-[0.4em] text-muted">
            <span>Encrypted</span>
